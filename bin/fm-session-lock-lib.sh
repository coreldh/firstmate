...
# ("-zsh", "-/bin/bash") and every ancestry walk passes one, where BSD basename
# reads that operand as an option cluster and writes "illegal option" to stderr
# on every turn end. Parameter expansion also saves a fork per hop.
