...
family_for_basename() {
  case "$1" in
    ...
    fm-crew-state.test.sh|fm-captain-churn.test.sh|fm-decision-hold-lifecycle.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-captain-churn.sh|bin/fm-decision-hold.sh|bin/fm-supervision*|bin/fm-transition-lib.sh|\
