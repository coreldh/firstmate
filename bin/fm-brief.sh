...
#   A missing datum makes the scaffold fail before it writes a brief.
...
Every forged artifact returns to an independent gate.
A scope change on a gated artifact means correct only the affected scope and return to an independent gate.
EOF
