...
test_active_dispatch_profile_allows_explicit_harness() {
  ...
  assert_contains "$launch" "'$ROOT/bin/fm-codex-hook-launch.sh' '$ROOT'" \
    "codex crewmate launch did not enter the trusted-root sandbox launcher"
...
test_active_dispatch_profile_does_not_block_secondmate_launch() {
  ...
  launch=$(cat "$LAUNCH_LOG")
  assert_contains "$launch" "'$sm_real/bin/fm-codex-hook-launch.sh' '$sm_real'" \
    "codex secondmate launch did not use its own tracked root as the protected hook anchor"
