...
phase_spawn() {
  ...
  assert_grep "FM_ROOT_OVERRIDE='$SUB_ABS'" "$LOG" "Codex launch did not bind hook scope to the secondmate home"
  assert_grep "FM_CODEX_HOOK_ROOT='$SUB_ABS'" "$LOG" "Codex launch did not anchor hook code to the secondmate home"
