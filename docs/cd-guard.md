...
| Codex | `.codex/hooks.json` PreToolUse hook that executes the manifest-verified staged checker through the [Codex hook payload boundary](architecture.md#codex-hook-payload-boundary) | Blocks on exit 2 and displays stderr. |
