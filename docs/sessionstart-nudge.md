...
| Codex | `.codex/hooks.json` resolves the wrapper through the anchored and manifest-verified payload boundary owned by [`architecture.md`](architecture.md#codex-project-hook-payload-integrity). | Native stdout context injection is supported. |
