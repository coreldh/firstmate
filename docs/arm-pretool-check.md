...
| --- | --- | --- |
| Codex | `.tool_input.command` | The `.codex/hooks.json` command resolves the checker through [`architecture.md`](architecture.md#codex-project-hook-payload-integrity), forwards the complete stdin payload, and Codex blocks on exit 2. |
