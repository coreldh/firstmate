...
The refresh lifts the registered-secondmate count bound and refuses publication when Bearings reports any carrier-relevant upstream omission, including bounded child, decision, queued, report, registry, or unreadable-home state.
